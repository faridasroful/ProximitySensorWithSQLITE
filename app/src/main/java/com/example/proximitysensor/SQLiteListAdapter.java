...
public class SQLiteListAdapter extends BaseAdapter {
    ...
    private ArrayList<String> user_value;

    SQLiteListAdapter(Context context1, ArrayList<String> ID, ArrayList<String> TITLE, ArrayList<String> VALUE) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.textView_value = convertView.findViewById(R.id.text_value);
        ...
        holder.textView_value.setText(user_value.get(position));
        return convertView;
    }
